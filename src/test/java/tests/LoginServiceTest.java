...
public class LoginServiceTest {
    ...
    void loginSuccess() {
        createRequestData(member.getUserId(), member.getUserPw()); // 이미 가입된 유저기 때문에 로그인이 되어야함
        assertDoesNotThrow(() -> {
    ...
    private void fieldEachCheck(HttpServletRequest request, String word) { // 필수 항목 검증할때 정확한 검증을 위한
